  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Switches</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Switch Listing</h3>

                <div class="card-tools">
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ route('switches.create') }}">Add</a>
                    </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr> 
                        ...
                        <td>{{ $switch->ip }}</td>
                        <td>{{ $switch->cps }}</td>
                        <td>{{ $switch->call_limit }}</td>
                        <td>{{ $switch->status }}</td>
                        <td>{{ $switch->created_at->format('jS F Y') }}</td>
                        
                        <td>
                            <form action="{{ route('switches.destroy', $switch->id) }}" method="POST">
                               <!--  <a class="btn btn-info" href="">Show</a> -->
                                <a class="btn btn-primary" href="{{ route('switches.edit', $switch->id) }}">Edit</a>
