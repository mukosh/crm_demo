...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="{{ URL::asset('public/plugins/datatables-bs4/css/dataTables.bootstrap4.css')}}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ URL::asset('public/dist/img/AdminLTELogo.png') }}" alt="Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Logic Venture</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @endif
           ...
           <!--  <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/demo/public/clients" class="nav-link">
          ...
          @if(Auth::user()->role === 'Admin')
          <li class="nav-item has-treeview">
          @if( Request::segment(1)=='switches')  
            <a href="{{ url('/switches') }}" class="nav-link active">
          @else
           <a href="{{ url('/switches') }}" class="nav-link">
          @endif
              <i class="nav-icon fas fa-user"></i>
              <p> Switches </p>
            </a> 
          ...
          <li class="nav-item has-treeview"> 
            @if( Request::segment(1)=='callers')  
            <a href="{{ url('/callers') }}" class="nav-link active">
            @else
             <a href="{{ url('/callers') }}" class="nav-link">
            @endif
          ...
          @if(Auth::user()->role === 'Admin' || Auth::user()->role === 'Client')
          <li class="nav-item has-treeview"> 
            @if( Request::segment(1)=='sounds')  
            <a href="{{ url('/sounds') }}" class="nav-link active">
            @else
             <a href="{{ url('/sounds') }}" class="nav-link">
            @endif
          ...
          @if(Auth::user()->role === 'Admin' || Auth::user()->role === 'Client')
          <li class="nav-item has-treeview"> 
            @if( Request::segment(1)=='phonebooks')  
            <a href="{{ url('/phonebooks') }}" class="nav-link active">
            @else
             <a href="{{ url('/phonebooks') }}" class="nav-link">
            @endif
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"> 
                @if( Request::segment(1)=='recharge')  
                  <a href="{{ url('/recharge') }}" class="nav-link active">
                @else
                 <a href="{{ url('/recharge') }}" class="nav-link">
                @endif
                  <i class="far fa-circle nav-icon"></i>
                  <p>Recharge</p>
                </a>
